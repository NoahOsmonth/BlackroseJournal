<!-- ============================================================
     ARCHIVED REFERENCE — SUPERSEDED
     ============================================================
     The original "Rosebud Memory Loom" phone-local design: memory
     atoms, six layers, weekly consolidation loop, five-phase roadmap.

     Superseded by the offline-file architecture in
     .planning/offline-memory/ (memoryFiles + memoryRetrieval + Dream).

     Status of its roadmap:
       Phase 1  LANDED   (localMemory atoms, capsule, weekly summary)
       Phase 2  LANDED   (manual notes, protected from pruning, Memory Hub)
       Phase 3  NOT BUILT (idle background consolidation, contradiction fading)
       Phase 4  PARTIAL  (embeddings on digests/rollups, graph; no SQLite)
       Phase 5  NOT BUILT (prospection-guided retrieval)

     Phases 3-5 are live input to .planning/context-retention/.
     ============================================================ -->

<!-- Recovered from commit 3d044aa^ · original path: idea.md -->
