<!-- ============================================================
     ...
     ============================================================
     Restored from git history for reference only.

     The cloud-authoritative memory platform this document describes
     (LOCAL -> MIRROR -> SHADOW -> CLOUD) was REMOVED on 2026-08-18.
     AGENTS.md forbids resurrecting it or its storage keys:
       @rosebud_cloud_memory_mirror_outbox
       @rosebud_memory_dataset_binding
     Guard test: __tests__/backend-local-only.test.ts

     Mine this for REQUIREMENTS and invariants. Do not mine it for
     implementation, schema, branches, or storage keys.
     ============================================================ -->

<!-- Recovered from commit f2415ff^ · original path: docs/superpowers/specs/2026-07-28-rosebud-backend-database-portability-design.md -->
